...
- [Dokumentation](#dokumentation)
  - [Objekterkennung](#objekterkennung)
    - [Training](#training)
    - [Objekterkennung](#objekterkennung-1)
      - [Grundlagen der Objekterkennung](#grundlagen-der-objekterkennung)
      - [YOLO: You Only Look Once](#yolo-you-only-look-once)
  - [Auslesen und Verarbeitung der Brillendaten](#auslesen-und-verarbeitung-der-brillendaten)
    - [Funktionsweise Pupil Capture](#funktionsweise-pupil-capture)
    - [Funktionsweise Python-Skript zur Verarbeitung der Brillen-Daten](#funktionsweise-python-skript-zur-verarbeitung-der-brillen-daten)
      - [Vorbereitung](#vorbereitung)
      - [Datenübertragung](#datenübertragung)
      - [Empfang der Daten](#empfang-der-daten)
      - [Objekterkennung](#objekterkennung-2)
      - [Gesammelte Verarbeitung und Versenden über MQTT](#gesammelte-verarbeitung-und-versenden-über-mqtt)
      - [Separate Effizientere Version](#separate-effizientere-version)
  - [Übertragung zwischen Brille und Webseite](#übertragung-zwischen-brille-und-webseite)
  - [Webseite (Beispielüberschrift)](#webseite-beispielüberschrift)
  - [get Started (Beispielüberschrift)](#get-started-beispielüberschrift)
...
1. Zum Starten des Programms muss zuerst die Brille mit dem Computer verbunden werden.
2. Danach sollte sichergestellt werden, dass die Software von Pupil Labs installiert ist.  https://docs.pupil-labs.com/core/getting-started/
3. Danach muss bei Bedarf der Pfad zur Software Pupil Capture angepasst werden.
4. Danach kann das Startskript gestartet werden und die Webseite sollte sich nach einiger Zeit von selbst öffnen.
